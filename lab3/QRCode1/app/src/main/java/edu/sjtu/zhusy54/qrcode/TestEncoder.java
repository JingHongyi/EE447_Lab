                        ...
                        for (int y = 0; y < height; y++) {
                            for (int x = 0; x < width; x++) {
                                if (matrix.get(x, y)) {
                                    ...
                                    switch (index){
                                        //case 0:pixels[y * width + x] =Color.BLACK;break;
                                        case 0:pixels[y * width + x] =Color.GREEN;break;
                                        case 1:pixels[y * width + x] =Color.RED;break;
                                        //case 3:pixels[y * width + x] =Color.BLUE;break;
                                        //case 4:pixels[y * width + x] =Color.YELLOW;break;
                                    }
